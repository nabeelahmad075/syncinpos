...
namespace syncinpos.Migrations
{
    ...
    [Migration("20250306105547_TableFKeyAdded")]
    partial class TableFKeyAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("syncinpos.Entities.Accounts.DetailAccounts.DetailAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("tblDetailAccounts");
                });

            modelBuilder.Entity("syncinpos.Entities.Accounts.MainAccounts.MainAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("syncinpos.Entities.Accounts.Types.MainType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("syncinpos.Entities.HR.Designations.Designation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("syncinpos.Entities.Inventory.Items.Item", b =>
                {
                    ...
                    b.ToTable("tblItemDefinitions");
                });

            modelBuilder.Entity("syncinpos.Entities.Inventory.Sections.Section", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("syncinpos.Entities.Inventory.Units.UnitOfMeasurement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("tblUnitOfMeasurements");
                });

            modelBuilder.Entity("syncinpos.Entities.LocationTypes.LocationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("tblLocationTypes");
                });

            modelBuilder.Entity("syncinpos.Entities.Locations.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("BankChargesLabel")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");

                    b.Property<decimal>("BankChargesPercent")
                        .HasColumnType("decimal(24,4)");

                    b.Property<int?>("BankTaxDetailAccountId")
                        .HasColumnType("int");

                    b.Property<int?>("CashTaxDetailAccountId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CreditCardTaxDetailAccountId")
                        .HasColumnType("int");

                    b.Property<int?>("CreditTaxDetailAccountId")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("EnableBankCharges")
                        .HasColumnType("bit");

                    b.Property<bool>("EnableDeliveryCharges")
                        .HasColumnType("bit");

                    b.Property<bool>("EnableServicesCharges")
                        .HasColumnType("bit");

                    b.Property<bool>("FixedDeliveryCharges")
                        .HasColumnType("bit");

                    b.Property<bool>("FixedServicesCharges")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("ServiceChargesLabel")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");

                    b.Property<string>("SlipNotes")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<decimal>("TaxPercentOnBank")
                        .HasColumnType("decimal(10,4)");

                    b.Property<decimal>("TaxPercentOnCash")
                        .HasColumnType("decimal(10,4)");

                    b.Property<decimal>("TaxPercentOnCredit")
                        .HasColumnType("decimal(10,4)");

                    b.Property<decimal>("TaxPercentOnCreditCard")
                        .HasColumnType("decimal(10,4)");
                    ...
                    b.HasIndex("BankTaxDetailAccountId");

                    b.HasIndex("CashTaxDetailAccountId");

                    b.HasIndex("CreditCardTaxDetailAccountId");

                    b.HasIndex("CreditTaxDetailAccountId");
            ...
            modelBuilder.Entity("syncinpos.Entities.Regions.Region", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("syncinpos.Entities.Sales.DayCloses.DayReversedHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("DayCloseId");

                    b.ToTable("tblDayReversedHistory");
                });

            modelBuilder.Entity("syncinpos.Entities.Sales.POS.POSDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("tblPOSDetail");
                });

            modelBuilder.Entity("syncinpos.Entities.Sales.POS.POSMaster", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal>("BankChargesPer")
                        .HasColumnType("decimal(10,4)");

                    b.Property<int?>("CoverTable")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("DeliveryChargesPer")
                        .HasColumnType("decimal(10,4)");
                    ...
                    b.Property<decimal>("SalesTaxPer")
                        .HasColumnType("decimal(10,4)");

                    b.Property<decimal>("ServiceCharges")
                        .HasColumnType("decimal(10,4)");

                    b.Property<decimal>("ServiceChargesPer")
                        .HasColumnType("decimal(10,4)");
            ...
            modelBuilder.Entity("syncinpos.Entities.Setups.Tables.TableEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("syncinpos.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("syncinpos.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("syncinpos.Entities.HR.Employees.Employee", b =>
                {
                    ...
                    b.HasOne("syncinpos.Entities.HR.Designations.Designation", "Designation")
                        .WithMany()
            ...
            modelBuilder.Entity("syncinpos.Entities.Inventory.ItemCategories.ItemCategory", b =>
                {
                    b.HasOne("syncinpos.Entities.Inventory.ItemTypes.ItemType", "ItemType")
                        .WithMany()
            ...
            modelBuilder.Entity("syncinpos.Entities.Inventory.Items.Item", b =>
                {
                    ...
                    b.HasOne("syncinpos.Entities.Inventory.Sections.Section", "Section")
                        .WithMany()
                        .HasForeignKey("SectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("syncinpos.Entities.Inventory.Units.UnitOfMeasurement", "UOM")
                        .WithMany()
                        .HasForeignKey("UOMId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("syncinpos.Entities.Locations.Location", b =>
                {
                    b.HasOne("syncinpos.Entities.Accounts.DetailAccounts.DetailAccount", "BankTaxDetailAccount")
                        .WithMany()
                        .HasForeignKey("BankTaxDetailAccountId");

                    b.HasOne("syncinpos.Entities.Accounts.DetailAccounts.DetailAccount", "CashTaxDetailAccount")
                        .WithMany()
                        .HasForeignKey("CashTaxDetailAccountId");

                    b.HasOne("syncinpos.Entities.Accounts.DetailAccounts.DetailAccount", "CreditCardTaxDetailAccount")
                        .WithMany()
                        .HasForeignKey("CreditCardTaxDetailAccountId");

                    b.HasOne("syncinpos.Entities.Accounts.DetailAccounts.DetailAccount", "CreditTaxDetailAccount")
                        .WithMany()
                        .HasForeignKey("CreditTaxDetailAccountId");

                    b.HasOne("syncinpos.Entities.LocationTypes.LocationType", "LocationType")
                        .WithMany()
                        .HasForeignKey("LocationTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("syncinpos.Entities.Regions.Region", "Region")
                        .WithMany()
                        .HasForeignKey("RegionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BankTaxDetailAccount");

                    b.Navigation("CashTaxDetailAccount");

                    b.Navigation("CreditCardTaxDetailAccount");

                    b.Navigation("CreditTaxDetailAccount");
            ...
            modelBuilder.Entity("syncinpos.Entities.Sales.DayCloses.DayReversedHistory", b =>
                {
                    b.HasOne("syncinpos.Entities.Sales.DayCloses.DayClose", "DayClose")
                        .WithMany()
                        .HasForeignKey("DayCloseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DayClose");
                });
            ...
            modelBuilder.Entity("syncinpos.Entities.Sales.POS.POSDetail", b =>
                {
                    ...
                    b.HasOne("syncinpos.Entities.Sales.POS.POSMaster", "POSMaster")
                        .WithMany("POSDetails")
                    ...
                    b.Navigation("POSMaster");
                });

            modelBuilder.Entity("syncinpos.Entities.Sales.POS.POSMaster", b =>
                {
                    b.HasOne("syncinpos.Entities.Sales.Customers.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("syncinpos.Entities.HR.Employees.Employee", "Employee")
                        .WithMany()
                    ...
                    b.HasOne("syncinpos.Entities.Setups.Tables.TableEntity", "Table")
                        .WithMany()
            ...
            modelBuilder.Entity("syncinpos.Entities.Setups.Tables.TableEntity", b =>
                {
                    b.HasOne("syncinpos.Entities.Setups.Floors.FloorEntity", "Floor")
                        .WithMany()
