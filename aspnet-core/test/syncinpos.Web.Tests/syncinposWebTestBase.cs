...
{
    public abstract class syncinposWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static syncinposWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(syncinposWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<syncinposDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<syncinposDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<syncinposDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<syncinposDbContext, Task<T>> func)
        {
            T result;
